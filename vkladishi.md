...
* Если один из полей пуст, то появится ошибка: `` *Обязательное поле ``
...
* При нажатии кнопки “Войти” с незаполненными полями имени и пароля появляется ошибка`` * Обязательно поле ``.
...
* __BUG__ При нажатии на пространство между днями нас редиректит на /film/undefined.
![alt text](img/calendar.png)
* При нажатии на ячейку с назначенным релизом фильма нас редиректит на страницу фильма.
