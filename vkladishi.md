...
1. Аватарка
   ...
   ![alt text](img/settingsDefault.png)
    - При нажатии на кнопку изменения аватарки появляется системный интерфейс выбора файла для загрузки на сайт. Размер 308p * 55p, с цветом #333333.
    ...
    - Изменение аватарки применяется после нажатия кнопки "сохранить". Размер 308p * 38p, с цветом #333333.
...
- Размеры постеров фильмов равны 200p * 300p. Боковые кнопки прокручивания слайдеров равны 50p * 50p.
