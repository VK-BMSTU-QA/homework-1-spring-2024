...
1. **[БАГ]** При переходе к сообщению от пользователя не по клику на уведомление, а любым другим способом, само уведомление о новом сообщении остается непрочитанным.
2. **[БАГ]** При получении нескольких уведомлений о новом сообщении от одного пользователя, они сохраняются даже после прочтения одного из уведомлений (кроме того, которое было прочитано).
3. **[БАГ]** При нахождении на сайте продолжительное время без перезагрузок и получения каких-либо уведомлений, работоспособность уведомлений может теряться. В таком случае пользователь больше уведомлений не получает.
...
6. **[БАГ]** При смене аватарки картинка на странице профиля и в хэдере не синхронизируются до обновления страницы.
...
3. При нажатии на кнопку “Лента” в sidebar’е редирект на [главную страницу](https://pinspire.site/) происходит корректно.
4. При нажатии на кнопку “Мессенджер” в sidebar’е редирект на [страницу с чатами](https://pinspire.site/messenger) происходит корректно.
5. При нажатии на кнопку “Подписки” в sidebar’е редирект на [страницу с подписками](https://pinspire.site/subscriptions) происходит корректно.
6. При нажатии на кнопку “Избранное” в sidebar’е редирект на [страницу с лайкнутыми пинами](https://pinspire.site/favourite) происходит корректно.
7. При нажатии на кнопку “Профиль” в sidebar’е редирект на [страницу профиля пользователя](https://pinspire.site/profile) происходит корректно.
9. При нажатии на кнопку “Данные аккаунта” в sidebar’е редирект на [страницу с данными аккаунта пользователя](https://pinspire.site/profile/data) происходит корректно.
10. При нажатии на кнопку “Безопасность” в sidebar’е редирект на [страницу с данными аккаунта, связанными с безопасностью](https://pinspire.site/profile/security), происходит корректно.
11. При нажатии на кнопку “Создать пин” в хэдере редирект на [форму для создания пина](https://pinspire.site/create/pin) отрабатывает корректно.
12. При нажатии на кнопку “Создать доску” в хэдере редирект на [форму для создания доски](https://pinspire.site/create/board) отрабатывает корректно.
