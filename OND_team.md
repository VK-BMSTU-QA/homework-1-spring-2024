...
2. При выборе категории поиска (Люди/Пины/Доски) пользователь получает результат только из этой категории (Люди/Пины/Доски) релевантные поисковому запросу.
...
5. При нажатии на кнопку “Создать пин” переход на форму для создания пина отрабатывает корректно
6. При нажатии на кнопку “Создать доску” переход на форму для создания доски отрабатывает корректно
7. При нажатии на кнопки в шапке сервиса происходит корректный переход, отрисовывается нужна страница
