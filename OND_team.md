...
3. При вводе в input поля **"Имя пользователя"** или **"Пароль"** неверных данных и дальнейшем нажатии на кнопку **"Войти"** над кнопкой возникает сообщение с информацией о том, что введено неверное имя пользователя или пароль и сами input поля выделятся красным цветом.
4. [**БАГ**] При вводе некорректных данных в input поле **"Пароль"** и нажатии на кнопку **"Войти"** появляется сообщение под полем и само поле выделяется красным цветом, но при повторном вводе данных сообщение не исчезает и цвет символов внутри поля остается красным (см. скриншот).
