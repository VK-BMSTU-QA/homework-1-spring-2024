...
* Не подписывается "у вас нет подписок" или "вы еще ни на кого не подписаны".
...
### Баги статуса в профиле донатера

* При нажатии вне окна статуса, ничего не происходит. Предполагается закрытие окна, т.к. это
...
* Аналогичные заполнения статуса [баги-статуса-в-профиле](#баги-статуса-в-профиле-донатера)
...
* При нажатии "выбрать файл" и выборе файла формата png, jpg до 10Мб файл начинает отображаться
   ...
   где видно фото(также фото появляется в навбаре)
...
### Баги смены пароля
* При отправке неправильного или пустого поля "старый пароль", перенаправляется на страницу профиля
...
### Баги смены логина
* При вводе логина, неудовлетворяющего условиям выше, выводится не ошибка с требованиями, 
а это:
...
* При отправке несовпадающих новых паролей появляется соответствующее сообщение об ошибке.
...
3. **Смена логина**
* При вводе логина, неудовлетворяющего условиям:
  * Логин должен быть от 3 до 16 символов
  * может содержать только цифры, латинские буквы и - _

  появляется сообщение с правилами для логина.
...
* Если перетянуть фото в редакторе поста, то оно продублируется(без кнопки удалить)
...
Ввиду проверки негативных кейсов тут, через редактирование их проверять не будем.
...
* При нажатии "выйти" перенаправляется на форму входа https://my-kopilka.ru/login

### Баги навбара/хедера
* Смещенное положение иконки автора на центр В Firefox 123.0 (64-bit)
...
Подготовка: необходимо изначально подписаться на двух авторов через поиск авторов
и переход на страницу автора.
...
Предварительно авторизуемся (логин - SanExpett, пароль - passworD1^^), перейдем на страниницу какого либо автора, перейдем на страницу автора Barinov.
...
## Донаты [Страница автора](https://my-kopilka.ru/profile28)
...
1. При нажатии кнопки "Остлеживать"
...
2. При нажатии кнопки "Перестать отслеживать" попдиска пропадает
 - Кнопка меняется на "Отслеживать"
 - Уменьшатеся счетчик попдичиков на 1
...
## Аналитика [страница статистики](https://my-kopilka.ru/statistic)
