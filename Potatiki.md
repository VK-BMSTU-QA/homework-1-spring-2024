...
2. Каждая карточка карусели содержит Фото товара, его название(которое помещается целиком, если меньше 2 строчек в высоту и обрезается тремя точками в конце, если больше двух строк в высоту), "Звездочку" с общим рейтингом, количество Отзывов и кнопка "В корзину".
...
5. При клике на "В корзину" отображается счетчик количества данного товара, добавленного в корзину. Также в хедере отображается счетчик количества всех товаров в корзине.
...
2. При наведении на название категории, меняется цвет шрифта.
...
1. При клике на поле с названием сортировки, установленно по умолчанию, отображается меню с выбором доступных сортировок: "По популярности", "По уменьшению цены", "По возрастанию цены", "По рейтингу".
...
1. При клике на кнопку "Добавить" отрисовывается кнопка "Сохранить" и окна для ввода: Города, Улицы, Дома, Квартиры.
...
5. Нет ограничений на количество добавленых адресов.
