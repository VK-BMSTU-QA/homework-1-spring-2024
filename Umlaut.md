...
_Положительные кейсы_:
1) Если в почте отсутствует кириллица, и она имеет структуру: "xxx@xxx.xxx", то сообщение о невалидном email пропадает, при условии, что оно появилось до этого.
2) Если обязательные поля заполнены валидно (имя, ваш пол, кого ищете, дата рождения, о себе), то данные сохранятся
3) 

**Баг**: При попытке смены почты на уже зантую пользователь не получает никакого ответа 

**Баг**: Можно ввести имя из 1 символа (отсутствует проверка)
