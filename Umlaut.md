...
3) Если ввести почту без символов до @ появляется сообщение: "Неверный email"
4) Если ввести почту с символами из кириллицы появляется сообщение: "Неверный email"
5) Если ввести имя меньше 2-х символов появляется сообщение: "Имя должно содержать не менее 2-х символов"
...
4) Когда заканчиваются свайпы, перекидывает на страницу приобретения премиума
...
**Баг**: Вместо фотографии можно загрузить совершенно любой файл.
...
6. Если пользователь авторизован, то при нажатии на надпись "Вас лайкнули" происходит закрытие списка пользователей, которые вас лайкнули. URL остается прежним.
7. Если пользователь авторизован, то при нажатии на надпись "Взаимные пары" происходит закрытие списка пользователей, с которыми у вас есть взаимная симпатия. URL остается прежним.
8. Если пользователь авторизован, то при нажатии на надпись "Диалоги" происходит закрытие списка пользователей, с которыми у вас есть начатый диалог. URL остается прежним.
...
_Положительные кейсы_:
1) Если регистрируются 5 новых пользователей по пригласительной ссылке, то пользователь получит премиум
...
5) При новом сообщении появляется плашка "непрочитанные сообщения"
...
_Положительные кейсы_:
1) При метче появляется попап с парой
2) При нажатии на кнопку "Написать" - открывается диалог
3) При нажатии на кнопку "искать дальше" - попап исчезает со страницы с анкетами
4) При новом сообщении приходит уведомление
5) При нажатии на уведомление открывается диалог
6) Уведомление исчезает
