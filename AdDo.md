...
3. Маленький баг - Если перейти по ссылке https://musicon.space/album/1000000, то не будет сообщения 404, будет пустой экран.
4. Пользователь может нажать на кнопку лайка альбома, после чего альбом добавится в коллекцию пользователя.
5. Список треков протестирован. См. [Список треков](#tracks)
...
4. Список треков протестирован. См. [Список треков](#tracks)
5. Альбомы кликабельны. При нажатии на любой из альбомов пользователь переходит на страницу альбома.
...
2. Редактирование плейлиста протестировано. См. [Страница создания плейлиста](#playlist-create)
3. У треков указаны только названия. Правильнее было бы выводить и имя артиста, и название трека. В остальном треки протестированы.
...
* При вводе некорректного названия плейлиста(пустой ввод, название с пробелами, использование некорректных символов: !"№;%:?*()_+=-`~\| и тд.) отображается сообщение об ошибке
* При вводе некорректного названия плейлиста(название с пробелами) отображается сообщение об ошибке
* При вводе некорректного названия плейлиста(использование некорректных символов: !"№;%:?*()_+=-`~\| и тд.) отображается сообщение об ошибке
...
* При вводе корректного названия и нажатии кнопки «Сохранить» плейлист создается
...
* При нажатии на аватар, открывается диалоговое окно выбора файла, при выборе некорректного файла выводится сообщение об ошибке
<hr>
...
* В случае отсутствия совпадений отображается надпись Трек/Альбом/Плейлист/Артист не найден
<hr>
...
* Кнопка "Следующий трек" работает исправно
* Кнопка "Пауза" работает исправно
* Кнопка "Плей" работает исправно
* Кнопка "Предыдующий трек" работает исправно
...
* При нажатии на кнопку "Лайк", она загорается акцентным цветом и трек добавляется в коллекцию
