...
* Ограничение на длину имени пользователя(до 30 символов) Если условие не удовлетворяет мы получаем общее сообщение об ошибке  
4. На этой странице можно поменять данные учетные записи со следующими ограничениями:
* Проверка поля email на регулярку email *[*]@[*].[*]* Если условие не удовлетворяет мы получаем общее сообщение об ошибке  
